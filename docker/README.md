...
In this demo, we are using the AWS logging driver to send to AWS the logs generated by the webserver. Instead of using AWS Cloudwatch logs, we have emulated the AWS environment using Localstack, mapped on port 4566.
